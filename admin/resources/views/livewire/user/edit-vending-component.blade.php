            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <h6 class="card-header"> Edit Vending
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="{{ url('update-vending/'.$vending->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vending_id" value="{{$vending->vending_id}}" class="form-control" id="vendingID" placeholder="Vending ID">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendingName">Vending Name</label>
                                        <input type="text" name="name" value="{{$vending->name}}" class="form-control" id="vendingName" placeholder="Vending Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="vendingLocation">Product Price</label>
                                        <input type="text" name="location" value="{{$vending->location}}" class="form-control" id="vendingLocation" placeholder="Vending Location">
                                    </div>
                                    <button type="submit" class="btn btn-primary me-2">Update</button>
                                    <a class="btn btn-dark" href="{{ url('user/vendingList') }}">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
