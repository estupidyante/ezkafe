    ...
    return (
        <LoadingOverlay
            ...
            <ProductDetailedContainer>
                ...
                <img src={URI + product?.image} alt={product?.name} style={{height:250, margin: 'auto', marginBottom:40, marginTop:80}}/>
                <div style={{ backgroundColor: '#ffffff', width: '100%', minHeight: 420, borderStartStartRadius: 20, borderStartEndRadius: 20, borderWidth: 1, borderStyle: 'solid', padding: '3rem' }}>
                    ...
                    <p style={{fontFamily:'Cormorant Garamond',fontSize:'large',marginBottom:20}}>{product?.description}</p>
